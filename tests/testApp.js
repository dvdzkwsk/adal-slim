...
app.controller("TaskCtl", [
    ...
    function (
        ...
        $scope.taskCall2 = function () {
            TaskFactory.getItem2("https://test.com/").then(
                function (response) {
                    $scope.task = response.data
                },
                function (err) {
        ...
        $scope.taskCall3 = function () {
            TaskFactory.getItem2("https://testapi.com/").then(
                function (response) {
                    $scope.task = response.data
                },
                function (err) {
        ...
        $scope.taskCall4 = function () {
            TaskFactory.getItem2("/someapi/item").then(
                function (response) {
                    $scope.task = response.data
                },
                function (err) {
        ...
        $scope.taskCall5 = function () {
            TaskFactory.getItem2("https://myapp.com/someapi/item").then(
                function (response) {
                    $scope.task = response.data
                },
                function (err) {
        ...
        $scope.taskCall6 = function () {
            TaskFactory.getItem2("http://testwebapi.com/").then(
                function (response) {
                    $scope.task = response.data
                },
                function (err) {
